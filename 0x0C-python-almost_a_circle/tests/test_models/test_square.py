...
Unittest classes:
    TestSquare_class_instantiation
    TestSquare_class_size
    TestSquare_class_x
    TestSquare_class_y
    TestSquare_class_order_of_initialization
    TestSquare_class_area
    TestSquare_class_stdout
...
class TestSquare_class_instantiation(unittest.TestCase):
...
class TestSquare_class_size(unittest.TestCase):
...
class TestSquare_class_x(unittest.TestCase):
...
class TestSquare_class_y(unittest.TestCase):
...
class TestSquare_class_order_of_initialization(unittest.TestCase):
...
class TestSquare_class_area(unittest.TestCase):
...
class TestSquare_class_stdout(unittest.TestCase):
    ...
    def test_str_method_print_size(self):
        s = Square(4)
        capture = TestSquare_class_stdout.capture_stdout(s, "print")
    ...
    def test_display_size(self):
        s = Square(2, 0, 0, 9)
        capture = TestSquare_class_stdout.capture_stdout(s, "display")
        self.assertEqual("##\n##\n", capture.getvalue())
...
class TestSquare_class_update_args(unittest.TestCase):
...
class TestSquare_class_update_kwargs(unittest.TestCase):
...
class TestSquare_class_to_dictionary(unittest.TestCase):
